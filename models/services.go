...
type Services struct {
	...
	ServiceCode        string    `orm:"column(service_code);size(100);null"`
	ServiceDescription string    `orm:"column(service_description);size(300);null"`
	Id                 int       `orm:"column(service_id);auto"`
	ServiceName        string    `orm:"column(service_name);size(100)"`
}
