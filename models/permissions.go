...
type Permissions struct {
	...
	PermissionCode        string    `orm:"column(permission_code);size(255);null"`
	PermissionDescription string    `orm:"column(permission_description);size(500);null"`
	Id                    int       `orm:"column(permission_id);auto"`
}
